...
for movie_id in MOVIE_ID_RANGE:
  ...
  if movie_details is not None:
    ...
    c.execute("INSERT INTO stock VALUES (?, ?, ?, ?, ?, ?, ?, ?)", (item_id, movie_details["name"], movie_details["description"], movie_details["poster"], movie_details["trailer"], cast_names, movie_id, movie_id))
